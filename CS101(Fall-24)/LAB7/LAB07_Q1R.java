 ...
 */
 ...
 public class LAB07_Q1R
 {
     public static void main(String [] args)
     {
        ...
        System.out.println("\nSpiral Iteration of Non-Square Matrix:");
        ...
        spiralIteration(nonSquareMatrix);
        spiralIteration(parentMatrix1 );
     ...
     public static void spiralIteration(int[][] matrix)
     {
        ...
        do
        {
            ...
            for(curColumn = traverse; curColumn < column - traverse && !isFinished(matrixSize, counted); curColumn++)
            {
                counted++;
                System.out.print(matrix[curRow][curColumn] + " ");
            }
            curColumn--;
            for(curRow = traverse + 1; curRow < row - traverse && !isFinished(matrixSize, counted); curRow++)
            {
                counted++;
                System.out.print(matrix[curRow][curColumn] + " ");
            }
            curRow--;
            for(curColumn--; curColumn >= traverse && !isFinished(matrixSize, counted); curColumn--)
            {
                counted++;
                System.out.print(matrix[curRow][curColumn] + " ");
            }
            traverse++;
            curColumn++;
            for(curRow--; curRow >= traverse && !isFinished(matrixSize, counted); curRow--)
            {
                counted++;
                System.out.print(matrix[curRow][curColumn] + " ");
            }
        ...
        while(!isFinished(matrixSize, counted));
        System.out.println();

     }

     /**
      * Control current size and given array
      */
     public static boolean isFinished(int total, int current)
     {
