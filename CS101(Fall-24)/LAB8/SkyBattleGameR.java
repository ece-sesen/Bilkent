...
public class SkyBattleGameR
{
    ...
    public final static int INVISIBLE_SWORD = 3;
    ...
    public final static char DARK_KNIGHT_SYMBOL = 'D';
    public final static char KNIGHT_SYMBOL = 'K';
    public final static char SWORD_SYMBOL = 'X';


    // Game Members
    public static int score = 0;
    private static BattleManagerR battleManager;
    ...
    {
        battleManager = new BattleManagerR();
    ...
    {
        KnightR knight = battleManager.getKnight();
        ArrayList<BattleColumnR> columns = battleManager.getColumns();
     ...
     */
    private static void displayBattleground(KnightR knight, ArrayList<BattleColumnR> columns) 
    {
        for (int i = 0; i < ROWS; i++) {
            ...
            for (int j = 0; j < COLS; j++) {
                ...
                BattleColumnR column = columns.get(j);
     ...
     */
    private static void displayGameInformation(KnightR knight) 
    {
     ...
     */
    private static boolean isKnightPositionedAt(KnightR knight, int x, int y) 
    {
